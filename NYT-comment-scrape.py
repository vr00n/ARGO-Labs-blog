...
def nytimes_comments(article):
    ...
    while total_comments>offset:
        ...
        file=file[4:-2] #clean the file by remvoings some clutter at the back end
	#print file
